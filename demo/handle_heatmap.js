/*eslint comma-spacing:0 no-comma-dangle:0 */
//
...
var getData = function() {
  ...
  var len = heatmap.length,
    noise = u.gaussian(500,100,len);
  for ( var i=1 /* skip first row! */; i<len; i++ ) {
    heatmap[i][2] = Math.round(heatmap[i][2]*100+noise[i])/100;
  }
...
module.exports = {
  ...
  path: [ "/get/heatmap/data" ] // Set this path correctly
};
